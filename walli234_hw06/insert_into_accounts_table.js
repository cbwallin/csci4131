...
var con = mysql.createConnection({
  ...
  user: "C4131S19G117", // replace with the database user provided to you
  password: "13719", // replace with the database password provided to you
  database: "C4131S19G117", // replace with the database user provided to you
  port: 3306
});
